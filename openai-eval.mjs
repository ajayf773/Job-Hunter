#!/usr/bin/env node
/**
 * openai-eval.mjs — OpenAI-compatible Job Offer Evaluator for job-hunter-ai
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║       job-hunter-ai — OpenAI-compatible Evaluator (any endpoint)     ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  job-hunter-ai EVALUATION — powered by ' + modelName + ' (' + endpointHost + ')');
