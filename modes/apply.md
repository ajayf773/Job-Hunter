...
5. **job-hunter-ai proof point**: Include in "Additional info" if there is a field for it
...
4. Suggest next step: run the `contacto` mode (`/job-hunter-ai contacto` where available) for LinkedIn outreach
