...
5. **job-hunter-ai proof point**: "Additional information" जैसा field हो तो include करें
...
3. अगला step suggest करें: hiring manager के लिए LinkedIn outreach के लिए `/job-hunter-ai contacto`
