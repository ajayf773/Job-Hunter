# Geteilter Kontext -- job-hunter-ai (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle job-hunter-ai-Modi
     in der deutschen Variante. Bevor du job-hunter-ai verwendest, MUSST du:
