...
If not:
> "No session transcripts found yet. Run `/job-hunter-ai interview` on a role after your next interview to generate a debrief, then come back to check for red flags."
