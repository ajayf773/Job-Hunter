# job-hunter-ai on the Free Tier (Antigravity CLI)

job-hunter-ai works with **Antigravity CLI's free tier** — no API key or paid
...
a rate-limit error; job-hunter-ai will pause and suggest retrying tomorrow.
