...
const CONFIG_KEY = "job-hunter-ai:config";
const CHAT_KEY = "job-hunter-ai:chat";
...
const GREETING =
  "Hi — I'm your job-hunter-ai assistant. I can walk you through onboarding, answer questions about your pipeline, or take you where you need to go. What would you like to do?";
...
export function AssistantConsole() {
  ...
  const suggestions = useMemo(() => {
    ...
    if (!pipeline.applications.length && !pending.length) {
      return [
        { label: "Help me get set up", send: "Help me get started with job-hunter-ai — what do you need from me?" },
