...
// the CANONICAL public text from job-hunter-ai.org/methodology + /docs — rendered
  ...
  return (
    <details className="group mt-10 overflow-hidden rounded-2xl border border-border bg-surface/30">
      <summary className="flex cursor-pointer list-none items-center gap-2 px-5 py-3.5 text-sm font-medium transition-colors hover:bg-surface-hover">
        How job-hunter-ai scored this — and why it&apos;s for <span className="text-landing">you</span>
      ...
      <div className="space-y-5 border-t border-border px-5 py-4 text-sm">
        <p className="text-muted">
          ...
          <strong className="text-brand">4.0</strong> is the apply / don&apos;t-apply line — below it, job-hunter-ai
        ...
        <a
          href="https://job-hunter-ai.org/methodology"
          target="_blank"
          rel="noreferrer"
