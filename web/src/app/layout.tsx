...
export const metadata: Metadata = {
  title: "job-hunter-ai — official web experience",
  description: "The official, local-first web experience for job-hunter-ai.",
  ...
  appleWebApp: { capable: true, statusBarStyle: "black-translucent", title: "job-hunter-ai" },
};
...
const THEME_SCRIPT = `(function(){try{var t=localStorage.getItem('job-hunter-ai:theme');var d=t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches);if(d)document.documentElement.classList.add('dark');var m=document.querySelector('meta[name="theme-color"]');if(!m){m=document.createElement('meta');m.setAttribute('name','theme-color');document.head.appendChild(m);}m.setAttribute('content',d?'#0a0a0a':'#f7f6f3');}catch(e){document.documentElement.classList.add('dark');}})();`;
