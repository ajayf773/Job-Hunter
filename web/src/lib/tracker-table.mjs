 ...
 * `tracker-aliases.json` in the job-hunter-ai root — the same single source
 ...
 * JSON file read with fs, like every other job-hunter-ai file this app consumes.
 *
 ...
 * @param {string} rootDir - job-hunter-ai root (careerOpsRoot() on the web side).
 ...
 * @param {string} rootDir - job-hunter-ai root holding tracker-aliases.json.
