# job-hunter-ai web (alpha)

An **experimental, opt-in web UI** for job-hunter-ai. It is a local-first *view* over
...
> [Discussion #1142](https://github.com/santifer/job-hunter-ai/discussions/1142) ·
> roadmap context → [Discussion #156](https://github.com/santifer/job-hunter-ai/discussions/156).
...
Open http://localhost:3000. The app reads the job-hunter-ai checkout it lives in
...
Set `job_hunter_ai_ROOT=/path/to/checkout` in `web/.env.local` to point the app at
a different job-hunter-ai directory (useful for testing against sample data).
