#!/usr/bin/env node
/**
 * openai-tailor.mjs — OpenAI-compatible CV Tailoring for job-hunter-ai
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║      job-hunter-ai — OpenAI-compatible CV Tailoring (Headless)      ║
╚══════════════════════════════════════════════════════════════════╝
...
// Build system prompt
// ---------------------------------------------------------------------------
const systemPrompt = `You are job-hunter-ai, an AI-powered CV tailoring engine.
