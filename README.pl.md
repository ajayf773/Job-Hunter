...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="job-hunter-ai — Wieloagentowy system poszukiwania pracy" width="800"></a>
</p>
...
<p align="center">
  <a href="https://trendshift.io/repositories/25195" target="_blank"><img src="https://trendshift.io/api/badge/repositories/25195" alt="santifer%2Fjob-hunter-ai | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>
...
job-hunter-ai ([job-hunter-ai.org](https://job-hunter-ai.org), znany też jako **careerops**) zamienia dowolne AI CLI w pełne centrum dowodzenia poszukiwaniem pracy. Zamiast ręcznego śledzenia aplikacji w arkuszu kalkulacyjnym, dostajesz pipeline zasilany AI, który:
...
> **Ważne: to NIE jest narzędzie do masowego wysyłania aplikacji.** job-hunter-ai to filtr — pomaga znaleźć te kilka ofert wartych twojego czasu spośród setek. System stanowczo odradza aplikowanie na oferty z oceną poniżej 4.0/5. Twój czas jest cenny, podobnie jak czas rekrutera. Zawsze sprawdzaj przed wysłaniem.

job-hunter-ai działa agentowo: Claude Code nawiguje po stronach kariery z Playwright, ocenia dopasowanie rozumując nad twoim CV kontra opis stanowiska (nie przez dopasowanie słów kluczowych) i dostosowuje CV do każdego ogłoszenia.
...
Zbudowany przez kogoś, kto użył go do oceny 740+ ofert pracy, wygenerowania 100+ spersonalizowanych CV i zdobycia roli Head of Applied AI. [Przeczytaj pełne case study](https://santifer.io/job-hunter-ai-system).
...
To sklonuje najnowszą wersję do `./job-hunter-ai` i zainstaluje zależności. Następnie:
...
**Przy pierwszym uruchomieniu job-hunter-ai przeprowadza Cię przez konfigurację — CV, profil i docelowe stanowiska — wyłącznie przez rozmowę. Nic nie trzeba edytować ręcznie.**
...
job-hunter-ai to jedna komenda slash z wieloma trybami:

```text
/job-hunter-ai                    → Pokaż wszystkie dostępne komendy
/job-hunter-ai {wklej ofertę}     → Pełny auto-pipeline (ocena + PDF + tracker)
/job-hunter-ai scan               → Skanuj portale w poszukiwaniu nowych ofert
/job-hunter-ai pdf                → Generuj CV zoptymalizowane pod ATS
/job-hunter-ai batch              → Wsadowa ocena wielu ofert
/job-hunter-ai tracker            → Podgląd statusu aplikacji
/job-hunter-ai apply              → Wypełnianie formularzy aplikacyjnych z AI
/job-hunter-ai pipeline           → Przetwarzanie kolejki URL
/job-hunter-ai contacto           → Wiadomość na LinkedIn
/job-hunter-ai deep               → Szczegółowe badanie firmy
/job-hunter-ai training           → Ocena kursu/certyfikatu
/job-hunter-ai project            → Ocena projektu portfolio
```

Możesz też po prostu wkleić URL oferty lub jej treść — job-hunter-ai automatycznie to wykryje i uruchomi pełny pipeline.
...
job-hunter-ai obsługuje główne polskie portale IT. Dwa z nich — JustJoin.it i NoFluffJobs — mają publiczne API i mogą być zintegrowane jako źródła Level 0 (zero tokenów, brak WebSearch, świeże dane w czasie skanowania). Pozostałe portale wymagają weryfikacji ręcznej lub przez Playwright.
...
job-hunter-ai uwzględnia specyfikę polskiego rynku pracy przy ocenianiu ofert:
...
Jestem Santiago — Head of Applied AI, były founder (zbudowałem i sprzedałem firmę, która nadal działa z moim nazwiskiem). Zbudowałem job-hunter-ai do zarządzania własnym poszukiwaniem pracy. Zadziałało: użyłem go do zdobycia swojej obecnej roli.
...
**job-hunter-ai to lokalne narzędzie open source, NIE usługa hostingowa.** Korzystając z tego oprogramowania, potwierdzasz:
...
<a href="https://github.com/santifer/job-hunter-ai/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/job-hunter-ai" alt="Współtwórcy" />
</a>

Znalazłeś pracę dzięki job-hunter-ai? [Podziel się swoją historią!](https://github.com/santifer/job-hunter-ai/issues/new?template=i-got-hired.yml)

## Licencja i znak towarowy

Kod jest licencjonowany na [MIT](LICENSE). Nazwa i marka „job-hunter-ai" są regulowane przez [Politykę Znaków Towarowych](TRADEMARK.md) — dozwolone dla użytku społecznościowego, zastrzeżone dla komercyjnego nazewnictwa produktów i endorsementu.
