...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="job-hunter-ai — Multi-agent jobsøgningssystem" width="800"></a>
</p>
...
job-hunter-ai ([job-hunter-ai.org](https://job-hunter-ai.org), også kendt som **careerops**) forvandler et hvilket som helst AI-CLI til en komplet kommandocentral for jobsøgning. I stedet for manuelt at spore ansøgninger i et regneark får du en AI-drevet pipeline, der:
...
> **Vigtigt: dette er IKKE et værktøj til masseudsendelse af ansøgninger.** job-hunter-ai er et filter — det hjælper dig med at finde de få stillinger blandt hundredvis, der er din tid værd. Systemet fraråder kraftigt at ansøge stillinger med en vurdering under 4,0/5. Din tid er værdifuld, og det samme er rekrutterens. Tjek altid efter, før du sender.

job-hunter-ai arbejder agentisk: Claude Code navigerer karrieresider med Playwright, vurderer match ved at ræsonnere over dit CV kontra stillingsopslaget (ikke via søgeordsmatchning) og tilpasser CV'et til hvert opslag.
...
Bygget af en, der brugte det til at vurdere 740+ stillinger, generere 100+ skræddersyede CV'er og lande en rolle som Head of Applied AI. [Læs hele case-studiet](https://santifer.io/job-hunter-ai-system).
...
Dette kloner den nyeste version til `./job-hunter-ai` og installerer afhængighederne. Derefter:
...
**Ved første kørsel guider job-hunter-ai dig gennem opsætningen — CV, profil og målstillinger — udelukkende via samtale. Intet skal redigeres manuelt.**
...
job-hunter-ai er én slash-kommando med flere tilstande:

```text
/job-hunter-ai                    → Vis alle tilgængelige kommandoer
/job-hunter-ai {indsæt stilling}  → Fuld auto-pipeline (vurdering + PDF + tracker)
/job-hunter-ai scan               → Skan portaler for nye stillinger
/job-hunter-ai pdf                → Generér ATS-optimeret CV
/job-hunter-ai batch              → Batch-vurdering af flere stillinger
/job-hunter-ai tracker            → Se status på ansøgninger
/job-hunter-ai apply              → AI-assisteret udfyldning af ansøgningsformularer
/job-hunter-ai pipeline           → Behandl kø af URL'er
/job-hunter-ai contacto           → LinkedIn-besked
/job-hunter-ai deep               → Dybdegående virksomhedsundersøgelse
/job-hunter-ai training           → Vurdering af kursus/certificering
/job-hunter-ai project            → Vurdering af porteføljeprojekt
```

Du kan også blot indsætte en stillings-URL eller dens tekst — job-hunter-ai registrerer det automatisk og kører hele pipelinen.
...
Jeg hedder Santiago — Head of Applied AI, tidligere founder (jeg byggede og solgte en virksomhed, der stadig kører med mit navn). Jeg byggede job-hunter-ai til at styre min egen jobsøgning. Det virkede: jeg brugte det til at lande min nuværende rolle.
...
**job-hunter-ai er et lokalt open source-værktøj, IKKE en hostingtjeneste.** Ved at bruge denne software anerkender du:
...
<a href="https://github.com/santifer/job-hunter-ai/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=santifer/job-hunter-ai" alt="Bidragydere" />
</a>

Fandt du job med job-hunter-ai? [Del din historie!](https://github.com/santifer/job-hunter-ai/issues/new?template=i-got-hired.yml)

## Licens og varemærke

Koden er licenseret under [MIT](LICENSE). Navnet og brandet "job-hunter-ai" er reguleret af [Varemærkepolitikken](TRADEMARK.md) — tilladt til fællesskabsbrug, forbeholdt kommerciel produktnavngivning og endorsement.
