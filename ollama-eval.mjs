#!/usr/bin/env node
/**
 * ollama-eval.mjs — Ollama-powered Job Offer Evaluator for job-hunter-ai
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           job-hunter-ai — Ollama Evaluator (local / free)          ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  job-hunter-ai EVALUATION — powered by Ollama (' + modelName + ')');
