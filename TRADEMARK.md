# job-hunter-ai Trademark Policy

This document explains how the "job-hunter-ai" name and brand may be used.
...
"job-hunter-ai," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  job-hunter-ai," "based on job-hunter-ai," "fork of job-hunter-ai," "extends
  job-hunter-ai" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  job-hunter-ai as origin if you like.
...
- **Product, service, or company names** that include "job-hunter-ai" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "job-hunter-ai Cloud," "job-hunter-ai Pro," "job-hunter-ai SaaS," "job-hunter-ai
  Hosted," "JobHunterAI by [vendor]," "Cloud job-hunter-ai," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by job-hunter-ai," "Official job-hunter-ai," "Sponsored by
  job-hunter-ai," "Partner of job-hunter-ai," "Featured by job-hunter-ai," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "job-hunter-ai" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("job-hunter-ai Certified," "job-hunter-ai Verified").
...
job-hunter-ai is a community-built project used by tens of thousands of
...
© 2026 Santiago Fernández de Valderrama. "job-hunter-ai"™ is a trademark of
