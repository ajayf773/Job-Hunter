#!/usr/bin/env node
/**
 * invite-match.mjs — Interview-Invite → Tracker Matcher for job-hunter-ai
 *
 ...
 *
 * Issue #1495 — github.com/santifer/job-hunter-ai
 */
...
function printSummary(result) {
  console.log(`\n${'='.repeat(70)}`);
  console.log('  Interview Invite Matcher — job-hunter-ai');
