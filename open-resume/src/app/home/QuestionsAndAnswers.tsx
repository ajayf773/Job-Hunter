...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Job-Hunter AI Resume Builder saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Job-Hunter AI Resume Builder apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Job-Hunter AI Resume Builder, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Job-Hunter AI Resume Builder
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Job-Hunter AI Resume Builder is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Job-Hunter AI Resume Builder intentionally only offers
          ...
          like references. Additionally, Job-Hunter AI Resume Builder only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Job-Hunter AI Resume Builder is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Job-Hunter AI Resume Builder believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Job-Hunter AI Resume Builder doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created Job-Hunter AI Resume Builder and why?",
    answer: (
      <p>
        Job-Hunter AI Resume Builder was created by{" "}
        ...
        that led to Job-Hunter AI Resume Builder, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Job-Hunter AI Resume Builder can help
  ...
  {
    question: "Q4. How can I support Job-Hunter AI Resume Builder?",
    answer: (
      <>
        <p>
          The best way to support Job-Hunter AI Resume Builder is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@job-hunter-ai-resume-builder.com">hello@job-hunter-ai-resume-builder.com</Link>{" "}
          or{" "}
          <Link href="https://github.com/xitanggg/job-hunter-ai-resume-builder/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support Job-Hunter AI Resume Builder is by spreading the words.
          ...
          by{" "}
          <Link href="https://github.com/xitanggg/job-hunter-ai-resume-builder">
