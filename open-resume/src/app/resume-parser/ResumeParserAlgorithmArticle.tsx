  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Job-Hunter AI Resume Builder
      ...
      <Paragraph>
        And that is everything about the Job-Hunter AI Resume Builder parser algorithm :)
      </Paragraph>
      <Paragraph>
