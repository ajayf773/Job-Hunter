...
describe("extract-profile tests - ", () => {
  ...
  it("Email", () => {
    expect(matchEmail(makeTextItem("  hello@job-hunter-ai-resume-builder.org  "))![0]).toBe(
      "hello@job-hunter-ai-resume-builder.org"
    );
  });
  ...
  it("Url", () => {
    expect(matchUrl(makeTextItem("  linkedin.com/in/job-hunter-ai-resume-builder  "))![0]).toBe(
      "linkedin.com/in/job-hunter-ai-resume-builder"
    );
    expect(matchUrl(makeTextItem("hello@job-hunter-ai-resume-builder.org"))).toBeFalsy();
  });
});
